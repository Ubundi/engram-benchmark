...
| P5 | Expand the evaluated system set beyond baseline vs Cortex | In progress | P0 | Research + Eng | Results still center on OpenClaw native vs Cortex, but `docs/system_matrix.md` now defines a five-row candidate lineup across OpenClaw and external runtimes | Main benchmark table with at least 3-5 systems or conditions and reproducible run artifacts |
