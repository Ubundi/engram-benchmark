...
| P3 | Freeze an official benchmark release with one canonical setting | Not started | P0 | Benchmark Maintainer | v3 exists, but official submission setting is still implicit | Versioned release notes, pinned split, pinned judge configuration, pinned settle defaults, and a release tag |
